...
class MatchService {
    ...
    private func createMockUsers() -> [User] {
        return [
            createSarahSmithUser(),
            createMichaelJohnsonUser(),
            createEmilyChenUser(),
            createDavidRodriguezUser()
        ]
    }
    
    private func createSarahSmithUser() -> User {
        return User(
            id: "2",
            name: "Sarah Smith",
    ...
    private func createMichaelJohnsonUser() -> User {
        return User(
            id: "3",
    ...
    private func createEmilyChenUser() -> User {
        return User(
            id: "4",
            name: "Emily Chen",
            userType: .coParent,
    ...
    private func createDavidRodriguezUser() -> User {
        return User(
            id: "5",
